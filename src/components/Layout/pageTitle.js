...
const EXACT = {
  ...
  '/admin/analytics/providers': 'Provider orders',
  '/admin/analytics/customers': 'Customer orders',
  '/admin/analytics/zones': 'Zone orders',
  '/admin/analytics/services': 'Service orders',
